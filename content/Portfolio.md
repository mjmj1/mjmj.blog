...
- 인게임 화면
  ![[InGame.png|600]]
##### 액션
대쉬, 공격(상호작용), 회전, 점프를 구현함
- 상호작용
  ![[Interaction.png|600]]
- 회전
  ![[Spin.gif|600]]
#### 반복 이벤트 시스템
- Hider는 주기적으로 미션을 수행해야 함
  ![[Mission.png|600]]
- 미션을 성공 or 실패에 따라 버프 및 디버프 제거 or 디버프를 얻음
- 버프
  ![[Buff.gif|600]]
- 디버프 제거
  ![[DebuffDelete.gif|600]]
- 디버프
  ![[Debuff.gif|600]]
- 주기적으로 태풍이 발생함
  ![[Tornado.png|600]]
- 발생한 태풍에 맞으면 5초 간 기절 및 넉백
  ![[TornadoHit.gif|600]]
##### 게임 결과
- Seeker는 Hider를 찾아 제거해야 하고 모두 제거하게 되면 승리
  ![[SeekerWin.gif|600]]
- Hider는 5분(설정 가능) 동안 살아남으면 승리
  ![[HiderWin.png|600]]
